...
function TrackerPageFullScreen({ onLogout, user, onShowAdmin }) {
  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--bg-primary)', color: 'var(--text-primary)' }}>
      ...
      >
        {/* Left - Logo (always first on desktop) */}
        ...
        {/* Center - Navigation */}
        <div className="w-full md:w-auto md:flex-1 flex justify-center order-3 mt-2 md:mt-0 md:mx-12 overflow-hidden">
          <NavigationTabs
        ...
        {/* Right - Actions (always last on desktop) */}
        ...
        {activeView === "projects" && (
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              {/* Desktop Search (new location) */}
              <div className="hidden md:flex items-center gap-2 px-3 py-2 rounded-lg text-sm transition-all"
                style={{
