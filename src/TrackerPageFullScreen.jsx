              ...
              {activeView === "projects" && (
                <>
                  <div className="relative flex-shrink-0">
                    <button className="flex items-center gap-1 md:gap-2 px-2 md:px-4 py-1 md:py-2 rounded-xl transition text-[10px] md:text-sm text-gray-700 dark:text-gray-300 hover:bg-black/5 dark:hover:bg-white/10"
                    >
                      <Tag size={14} />
                      <select
                        value={filterTag}
                  ...
                  <input
                    ...
                    className="flex-shrink-0 px-2 md:px-3 py-1 md:py-2 rounded-xl bg-transparent text-gray-800 dark:text-gray-200 w-20 md:w-48 text-[10px] md:text-sm border border-gray-300 dark:border-gray-700"
                  />
