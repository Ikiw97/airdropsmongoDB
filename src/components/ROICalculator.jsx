                ...
                >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full transition-all duration-300 rounded p-2 text-sm outline-none"
                        style={{
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full transition-all duration-300 rounded p-2 pl-6 text-sm outline-none"
                          style={{
                            background: "var(--bg-tertiary)",
                            border: "1px solid var(--border-primary)",
                            color: "var(--text-primary)"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full transition-all duration-300 rounded p-2 pl-8 text-sm outline-none"
                          style={{
                            background: "var(--bg-tertiary)",
                            border: "1px solid var(--border-primary)",
                            color: "var(--text-primary)"
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="w-full h-1 rounded-lg appearance-none cursor-pointer accent-cyan-500 transition-all duration-300"
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-4 transition-all duration-300 py-2 rounded font-semibold text-sm hover:opacity-80 transition"
                ...
                {result && (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="p-3 rounded border" style={{ background: "var(--bg-tertiary)", borderColor: "var(--border-primary)" }}>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      {savedCalculations.map((calc, i) => (
                        <div key={i} className="flex justify-between items-center p-2 rounded border" style={{ background: "var(--bg-tertiary)", borderColor: "var(--border-primary)" }}>
                          <div>
