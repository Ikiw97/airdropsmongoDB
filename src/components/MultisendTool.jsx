          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            >
              <div className="mb-4">
                ...
                <div className="flex gap-2 p-1 rounded-lg bg-slate-100 dark:bg-[#010409]">
                  <button
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="0x..."
                      className="w-full transition-all duration-300 rounded p-3 text-sm outline-none font-mono bg-slate-100 dark:bg-[#010409] text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-800"
                    />
                    {tokenInfo && (
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full h-40 transition-all duration-300 rounded p-3 text-sm outline-none font-mono resize-none bg-slate-100 dark:bg-[#010409] text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-800"
                ></textarea>
            ...
            >
              ...
              {txResults.length === 0 ? (
                ...
                <div className="space-y-2 max-h-[500px] overflow-y-auto pr-1 custom-scrollbar">
                  {txResults.map((tx, i) => (
                    <div key={i} className="p-3 rounded border text-xs bg-slate-100 dark:bg-[#010409] border-gray-200 dark:border-gray-800">
