        ...
        <div className="flex flex-col md:flex-row items-end gap-4">
          <div className="flex-1 w-full">
            ...
            <input
              ...
              className="w-full transition-all duration-300 rounded p-3 outline-none"
              style={{
                ...
                {showExportPassword ? (
                  <div className="flex gap-2">
                    <input
                      ...
                      className="transition-all duration-300 rounded px-3 py-2 text-sm flex-1 outline-none"
                      style={{
                        background: "var(--bg-tertiary)",
                        border: "1px solid var(--border-primary)",
                        color: "var(--text-primary)"
