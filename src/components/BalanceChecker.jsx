                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  <div className="md:col-span-4 space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        className="w-full h-40 transition-all duration-300 rounded p-3 text-sm outline-none font-mono bg-slate-100 dark:bg-[#010409] text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-800"
                        placeholder="0x..."
                  ...
                  <div className="md:col-span-4 space-y-4">
                    <div className="p-4 rounded-lg transition-all duration-300" style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-primary)" }}>
                      ...
                      <input
                        ...
                        className="w-full transition-all duration-300 border rounded p-2 text-sm outline-none mb-3 bg-slate-100 dark:bg-[#010409] text-gray-900 dark:text-gray-100 border-gray-200 dark:border-gray-800"
                      />
                      ...
                      {customCheckType === 'token' && (
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                          <input
                            ...
                            className="w-full transition-all duration-300 rounded p-2 text-sm outline-none mb-1 font-mono bg-slate-100 dark:bg-[#010409] text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-800"
                          />
                ...
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1 flex gap-2">
                      <select
                        className="transition-all duration-300 rounded px-3 text-sm outline-none bg-slate-100 dark:bg-[#010409] text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-800"
                      ...
                      <input
                        ...
                        className="flex-1 transition-all duration-300 border rounded px-3 py-2 text-sm outline-none font-mono bg-slate-100 dark:bg-[#010409] text-gray-900 dark:text-gray-100 border-gray-200 dark:border-gray-800"
