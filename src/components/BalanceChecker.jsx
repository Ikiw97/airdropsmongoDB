    ...
    <div className="w-full mb-6">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-lg font-bold" style={{ color: "var(--text-primary)" }}>Wallet Portfolio</h2>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  <div className="md:col-span-4 space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        className="w-full h-40 transition-all duration-300 rounded p-3 text-sm outline-none font-mono"
                      ...
                      {customCheckType === 'token' && (
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                          <input
                            ...
                            className="w-full transition-all duration-300 rounded p-2 text-sm outline-none mb-1 font-mono"
                            style={{ background: "var(--bg-tertiary)", border: "1px solid var(--border-primary)", color: "var(--text-primary)" }}
                          />
                ...
                <div className="space-y-6">
                  <div className="flex flex-col md:flex-row gap-4">
                    <div className="flex-1 flex gap-2">
                      <select
                        className="transition-all duration-300 rounded px-3 text-sm outline-none"
                        style={{ background: "var(--bg-tertiary)", border: "1px solid var(--border-primary)", color: "var(--text-primary)" }}
                        value={scannerChain}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {tokens.map((token, i) => (
                      <div
                        key={i}
                        className="p-4 rounded-lg flex items-center gap-4 transition-all duration-300 border hover:opacity-80"
