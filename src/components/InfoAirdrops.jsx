        ...
        {channels.map((ch, i) => (
          ...
          >
            <div className="flex items-center gap-4">
              ...
              {/* Channel Logo */}
              <div className="relative w-10 h-10 rounded-full overflow-hidden border transition-all duration-300 bg-slate-100 dark:bg-[#010409] border-gray-200 dark:border-gray-800">
                <img
                  src={ch.img}
                  alt={ch.name}
